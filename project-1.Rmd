...
# import the dataset 
```{r}
data <- read.csv("41598_2018_29592_MOESM3_ESM.xlsx", header = TRUE, stringsAsFactors = FALSE)
...
for (var in cont_vars) {
  ...
  # filters data removing outliers
  new_data <- new_data[new_data[[var]] >= lower_bound & new_data[[var]] <= upper_bound, ]
}
